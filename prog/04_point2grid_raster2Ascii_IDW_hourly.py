...
pointFiles = sorted(glob.glob("../point_extraction\\"+Target_timeScale+"\\"+Target_climate_variable+"\\"  + Target_year + "\\*.txt"))
schema_files = sorted(glob.glob("../point_extraction\\"+Target_timeScale+"\\"+Target_climate_variable+"\\" + Target_year + "\\*.ini"))
